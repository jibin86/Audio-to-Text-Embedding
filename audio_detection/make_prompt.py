...
def process_audio_directory(args):
    ...
    try:
        ...
        for filename in tqdm(audio_files):
            ...
            top_result_mat_sort, top_result_label_sort = sound.sound_event_detection_top_k(audio_path)

            result_text = top_result_label_sort[0]
        ...
        # 결과를 JSON 파일에 저장
        output_file = os.path.join(args.json_dir, f"audio_results_{args.audio_dir.split('/')[-1]}2.json") # "audio_results_train.json", "audio_results_test.json"
